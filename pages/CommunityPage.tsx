...
const DISCUSSIONS = [
  {
    ...
    time: "2 hours ago",
    title:
      "Optimizing Carbon Capture efficiency using reinforcement learning models",
    preview:
      "We have been testing a new RL agent on simulated porous materials and are seeing a 15% increase in adsorption rates. Is anyone else working with the OpenCatalyst dataset?",
  ...
  },
  {
    ...
    preview:
      "I have secured seed funding and IP for a mycelium-based packaging solution. Looking for a technical co-founder with a background in Material Science.",
  ...
  },
  {
    ...
    preview:
      "Having reviewed over 50 applications last cycle, I noticed three common mistakes deep tech founders make when addressing the 'Impact' section...",
    ...
    <div className="bg-slate-50 min-h-screen">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-xl">
              <FadeIn>
                ...
                <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                  Join a curated ecosystem of early adopters, scientists, and
                  founders working together to solve complex global challenges.
                </p>
            ...
            <div className="relative h-[500px] w-full hidden lg:flex items-center justify-center">
              ...
              <div
                className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden animate-float"
                ...
                <div className="p-4 space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs font-bold text-slate-900">
                        Elena Rostova{" "}
                        <span className="text-slate-400 font-normal">• 2h</span>
                      </div>
                      <div className="text-sm font-bold text-slate-800 mb-1">
                        Looking for datasets on carbon capture
                      </div>
                      <p className="text-xs text-slate-500 line-clamp-2">
                        Does anyone have access to the latest porous material
                        benchmarks?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-xs font-bold text-slate-900">
                        James Chen{" "}
                        <span className="text-slate-400 font-normal">• 5h</span>
                      </div>
                      <div className="text-sm font-bold text-slate-800 mb-1">
                        Co-Founder Search: AgriTech
                      </div>
                      <div className="flex gap-2 mt-2">
                        <span className="px-2 py-1 bg-slate-50 border border-slate-200 rounded text-[10px] font-medium text-slate-600">
                          Hardware
                        </span>
                        <span className="px-2 py-1 bg-slate-50 border border-slate-200 rounded text-[10px] font-medium text-slate-600">
                          Robotics
              ...
              {/* Match Card */}
              <div
                className="absolute bottom-20 -left-4 bg-white p-4 rounded-xl shadow-xl border border-slate-200 w-64 z-20 animate-float"
              ...
              >
                ...
                <div className="mt-3 flex gap-2">
                  <Button size="sm" className="w-full text-xs h-7 py-0">
                    Accept
                  </Button>
                  <button className="w-full text-xs font-bold text-slate-500 hover:bg-slate-50 rounded">
                    Ignore
                  </button>
                </div>
              </div>
          ...
          {[
            {
              ...
              title: "Forums",
              desc: "Technical discussions & Q&A.",
            },
            {
              icon: <Users size={24} />,
              title: "Teams",
              desc: "Find co-founders & talent.",
            },
            {
              icon: <Award size={24} />,
              title: "Mentorship",
              desc: "Connect with industry veterans.",
            },
            {
              icon: <BookOpen size={24} />,
              title: "Library",
              desc: "Open-source tools & papers.",
            },
          ].map((space, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-xl border border-slate-200 hover:border-primary-400 hover:shadow-md transition-all cursor-pointer group"
            >
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-6">
            ...
            {discussions.map((post) => (
              <div
                key={post.id}
                className="bg-white p-6 rounded-2xl border border-slate-200 hover:border-slate-300 transition-colors"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-full ${post.color} flex items-center justify-center font-bold text-sm`}
                    >
                      {post.avatar}
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                  <div className="flex gap-6">
                    <button
                      ...
                      className={`flex items-center gap-2 text-sm font-medium transition-colors ${!user ? "cursor-not-allowed opacity-50" : "hover:text-primary-600"} ${post.upvotes > 20 ? "text-slate-700" : "text-slate-500"}`}
                      title={!user ? "Log in to upvote" : "Upvote"}
                    >
                      <ThumbsUp size={18} /> {post.upvotes}
                    </button>
                    <button
                      className={`flex items-center gap-2 text-sm font-medium text-slate-500 transition-colors ${!user ? "cursor-not-allowed opacity-50" : "hover:text-primary-600"}`}
                    >
          ...
          <div className="lg:w-80 shrink-0 space-y-8">
            ...
            <div className="bg-primary-900 rounded-2xl p-6 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-primary-100 text-sm mb-6">
                  Find co-founders, engineers, and researchers for your next
                  project.
                </p>
                <Button variant="white" size="sm" fullWidth className="mb-3">
                  Find a Team
                </Button>
                <Button
                  variant="outline"
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <p className="text-xs text-slate-500 leading-relaxed mb-3">
                GIVA is a professional ecosystem. We prioritize constructive
                feedback, scientific integrity, and respectful collaboration.
              </p>
              <a
                href="#"
                className="text-xs font-bold text-slate-600 hover:text-primary-600 flex items-center gap-1"
              >
      ...
      <section className="py-20 bg-white border-t border-slate-200">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl text-center">
          <span className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-8 block">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl relative z-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            {user
              ...
              : "Join the global innovation ecosystem."}
          </h2>
          ...
          <div className="flex justify-center gap-4">
            <Button
              variant="white"
              size="lg"
              onClick={() => navigate(user ? "/ecosystem" : "/join")}
            >
