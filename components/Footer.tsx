    ...
    <footer className="bg-primary-900 text-white pt-24 pb-12 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-primary-900 font-bold text-xl">
                G
              </div>
              <span className="text-2xl font-bold tracking-tight">GIVA</span>
            </div>
            <p className="text-primary-100/70 text-sm leading-relaxed mb-8">
              A global science and innovation ecosystem moving ideas into
              real-world impact through collaboration, mentorship, and
              technology.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-primary-200 hover:bg-white/20 hover:text-white transition-all"
              >
                <Twitter size={18} />
              </a>
              <a
          ...
          {/* Links 1 */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-6 text-secondary-500">
              Platform
            </h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-primary-100/50">
          <p>
            &copy; {new Date().getFullYear()} GIVA Ecosystem. All rights
            reserved.
          </p>
